...
const confirmorder=()=>{
  ...
  return (
   < div>
    <div className="container paymentdis" style={{backgroundColor:"#FFCCBC",height:"150vh",width:"60vw",color:"brown"}}>
...
<div style={{marginTop:"40px"}}>
  ...
  <div className="container paymentdis2" style={{backgroundColor:"#FFCCBC",height:"150vh",width:"",color:"brown"}}>
        <form action="" style={{width:'px',border:'1px solid white',margin:'auto',borderRadius:"px",marginTop:"10px",}}>
        <h2 style={{color:"brown",fontSize:"3.2rem",}}>Payment</h2>

<div className="section" >
  <h4 style={{fontStyle:"italic",color:"brown"}}>Personal Information</h4>
<div style={{width:'px',  margin:'auto'}}>
<div className="" style={{width:'px'}} >
    <label for="fullname" >Full Name:</label>
    <input type="text" id="fullname" className="form-control" placeholder="Enter your full name"  />
  </div>
...
<div className="section m-2">
  <h2 style={{color:"brown",}}>Payment Method</h2>
...
<div style={{marginTop:"40px"}}>
  <input type="button" value="confirmorder" onClick={confirmorder} style={{padding:"5px",borderRadius:"px",backgroundColor:"white",color:"brown"}} />
</div>
  </div>
  </div>
  );
